defmodule ExAdmin.AssociationController do
  ...
  def toogle_attr(conn, %{"attr_name" => attr_name, "attr_value" => attr_value} = params) do
    defn = ExAdmin.get_registered_by_controller_route!(params["resource"], conn)
    ...
    render conn, "toogle_attr.js", attr_name: attr_name, attr_value: Map.get(model, attr_name_atom), id: model.id
  end
